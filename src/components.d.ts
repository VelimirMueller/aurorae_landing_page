...
declare module 'vue' {
  export interface GlobalComponents {
    Admin: typeof import('./components/pages/admin/index.vue')['default']
    ...
    LeftRight: typeof import('./components/structure/LeftRight.vue')['default']
    LeftRightScalingImage: typeof import('./components/structure/LeftRightScalingImage.vue')['default']
