<template>
  <h2 class="text-dark text-center mb-md-12 pt-12">Better<span class="text-highlight"> AI </span>Experience with<span class="text-highlight"> Aurorae </span></h2>

  <v-row class="px-md-12 px-2 py-12">
